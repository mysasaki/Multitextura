...
public class MeshFactory {
    ...
    /** EXERCICIO 01 **/
    public static Mesh loadTerrain(File file, float scale, int texRepeat, File image) throws IOException {
        BufferedImage img = ImageIO.read(file);
        BufferedImage img2 = ImageIO.read(image);
        ...
        return new MeshBuilder()
                ...
                .addVector3fAttribute("aNormal", normals)
                .addVector2fAttribute("aTexCoord", texCoords)
                .addVector4fAttribute("aTexRGBA", texRGBA)
                .setIndexBuffer(indices)
                .create();
    }
}
